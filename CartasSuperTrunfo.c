...
int main() {
    ...
    printf("A cidade com maior quantidade de potntos turisticos é : %d\n",
    pontos_turisticos1 > pontos_turisticos2);
    printf("O maior PIB é : %d\n",
    pib1 > pib2);
    printf("A maior área é : %d\n",
    area1 > area2);
    printf("A menor densidade polucaional é : %d\n",
    densidade_populacional1 < densidade_populacional2);
    printf("O maior PIB per capita é : %d\n",
    PIB_percapita1 > PIB_percapita2);
    printf("O super pode vencedor: %d \n",
